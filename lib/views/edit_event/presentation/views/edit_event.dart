...
class _EditEventState extends State<EditEvent> {
  ...
  @override
  void initState() {
    updateEventProvider = UpdateEventProvider(EditEventImplementation());
  ...
  void didChangeDependencies() {
    updateEventProvider.getInitLocation(
      context,
      LatLng(widget.eventDm.lat!, widget.eventDm.lng!),
    ).then((value) {
      setState(() {
                  ...
                  children: [
                    ...
                    CustomWidgetToDisplayInfo(
                      ...
                      onPressed: () async {
                       ...
                       await updateEventProvider.getInitLocation(
                          context,
                    ...
                    CustomElevatedButton(
                      txt: 'Update Event',
                      onPressed: () {
                        updateEventProvider.updateEvent(
                          context,
                          EventDm(
