                  ...
                  children: [
                    ...
                    Consumer<CreateEventProvider>(
                      builder: (context, value, child) {
                        CreateEventState state = value.state;
                        if (state is CreateEventStateFailure) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                (state.generalError ?? state.fireBaseError)!,
                              ),
                            ),
                          );
                        }
                        if (state is CreateEventStateSuccess) {
                          ...
                          onPressed: () {
                            ...
                            createEventProvider.addEvent(
                              EventDm(
                                ...
                                category:
                                    selectedCategory ?? categorysWithOutAll[0],
